---
title: "Paradigm Familiarization"
weight: 10
---
...
- [CI/CD & GitOps Tools](/docs/tools/ci-cd-tools.md) → Tool comparisons
- [IaC Tools](/docs/tools/iaac-tools.md) → Infrastructure as Code
...
- [DevSecOps & Security Tools](/docs/tools/security-devsecops.md) → Tool comparisons
...
- [MLOps & LLMOps Tools](/docs/tools/mlops-llmops-tools.md) → Tool comparisons
...
- [Cost Management & FinOps Tools](/docs/tools/cost-management-finops.md) → Tool comparisons
...
- [Platform Engineering Tools](/docs/tools/platform-engineering.md) → Tool comparisons
...
- [GitOps Tools](/docs/tools/gitops-tools.md) → Tool comparisons
...
|---|---|---|---|
| DevOps | ✅ [Landscape](/docs/research/devops-landscape-2026.md) | ✅ [CI/CD](/docs/tools/ci-cd-tools.md), [IaC](/docs/tools/iaac-tools.md), [Container](/docs/tools/container-orchestration.md), [Observability](/docs/tools/observability-monitoring.md), [Messaging](/docs/tools/messaging-streaming.md) | ✅ [Roadmap](/docs/guides/freelance-devops-roadmap.md) |
| GitOps | ✅ (in DevOps doc) | □ Pending | - |
| DevSecOps | ✅ [Landscape](/docs/research/devsecops-landscape-2026.md) | ✅ [Security Tools](/docs/tools/security-devsecops.md) | - |
| DataOps | ✅ [Landscape](/docs/research/dataops-landscape-2026.md) | - | → |
| MLOps | ✅ [Landscape](/docs/research/mlops-landscape-2026.md) | □ Pending | - |
| AIOps | ✅ [Landscape](/docs/research/aiops-landscape-2026.md) | ✅ [AI for DevOps](/docs/tools/ai-for-devops.md) | - |
